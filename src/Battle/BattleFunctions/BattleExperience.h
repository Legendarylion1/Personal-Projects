...
public:
	...
	void setup(Trainer* trainer, Menu* menu, Animator* animator, BattleMenuGraphics* battleMenuGraphics, Timer* timer, Input* input, DialogueRenderer* dialogueRenderer, int* playerPokemonIndex, int* opponentPokemonIndex);
