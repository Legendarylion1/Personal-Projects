...
public:
	...
	void setup(Trainer* trainer, Menu* menu, Renderer* renderer, DialogueRenderer* dialogueRenderer, Animator* animator, BattleMenuGraphics* battleMenuGraphics, Timer* timer, int* playerPokemonIndex, int* opponentPokemonIndex);
