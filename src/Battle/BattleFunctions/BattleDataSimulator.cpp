...
void BattleDataSimulator::setup(Trainer* trainer, Menu* menu, Renderer* renderer, DialogueRenderer* dialogueRenderer, Animator* animator, BattleMenuGraphics* battleMenuGraphics, Timer* timer, int* playerPokemonIndex, int* opponentPokemonIndex)
{
    m_trainer = trainer;
    m_menu = menu;
    m_renderer = renderer;
...
void BattleDataSimulator::simulateFlee(SimulationCommand command)
{
    ...
    {
        //m_flee = true;    //TODO: Mark Game End Flag
