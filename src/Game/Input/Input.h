...
private:
	...
	std::unordered_map<RequestType, std::string, RequestTypeHashFunction> m_activeRequests
	{
		...
		{{KeyPriority::MAIN, InputRequest::SPRINT, ControlType::KEYBOARD},	""},
		...
		{{KeyPriority::MAIN, InputRequest::SPRINT, ControlType::CONTROLLER_BUTTON	},		""},
	...
	std::unordered_map<InputKey, InputRequest, InputKeyHashFunction> m_keyEvents
	{
		...
		{InputKey{GLFW_GAMEPAD_BUTTON_Y, ControlType::CONTROLLER_BUTTON}, InputRequest::EMPTY},
